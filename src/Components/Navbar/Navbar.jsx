...
const Navbar = ({smile, netlogo1, childlogo}) => {
  return (
    <>
    <div className='nav_main'>
      <div className='nav_image'>
        <img src={netlogo1} alt="" />
      </div>
          ...
          <div className='navsmile'>
             ...
             <div className='nav-children'>
                ...
                <div className='pencil'>
                   <FaEdit size={"25px"}/><p>Manage Profiles</p> 
                </div>
                <div className='profile'>
                   <FaSmile size={"25px"}/><p>Transfer Profile</p>
                </div>
                <div className='account'>
                   <FaPerson size={"25px"}/><p>Account</p> 
                </div>
                <div className='help-centre'>
                   <FaQuestion size={"25px"}/><p>Help Centre</p>
                </div>
                <hr className='hori'/>
                <p className='home-signout'>Sign out of Netflix</p>
             </div>
          </div>
      </div>
    </div>
